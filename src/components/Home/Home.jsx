...
const Home = () => {
	return (
		<div>
			...
			>
				<div className='space-y-3 text-center  -mb-52 text-white flex flex-col items-center'>
					...
					/>
					<Link to={'/project'}>
						<button className='project z-20 text-base font-semibold   px-16 py-3 rounded-md'>
							MY WORKS
						</button>
					</Link>
				</div>
