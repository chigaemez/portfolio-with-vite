...
import { dash, portfolio, weather, video } from "../assets/image/Index";
import type { CONTACT, EDUCATION, Experiences, PROJECTS } from "./Type";
...
export const Education : EDUCATION[] = [
    {
    year: "2026 - Present",
    certificate: "Bachelor of Science (B.Sc.) in Cybersecurity", 
    name: "Open University of Nigeria",
    skills: [ "Object-Oriented Programming", "Database Management", "Software Engineering"],
  },
  {
    year: "2021 - 2023",
...
export const Contact: CONTACT = {
  ...
  phoneNo: "(+234) 9122174699",
  email: "Christopherorji18@gmail.com",
};
